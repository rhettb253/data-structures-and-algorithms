...
const listFoods = (recipe) => {
  ...
  for (let element of recipe.ingredients){
    let startEl = element.indexOf(' ');
    let endEl = element.indexOf(' ', startEl + 1);
    let newEl = element.slice(endEl + 1);
    result.push(newEl);
  }
  return result;
};
...
//   let result = [];
//   for (let element of recipe.ingredients){
//     let startEl = element.indexOf(' ', 2);
//     let newEl = element.slice(startEl+1);
//     result.push(newEl);
//   }
//   return result;
// };
