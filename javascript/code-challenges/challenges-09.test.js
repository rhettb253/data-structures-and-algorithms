...
const maxInArray = (arr) => {
  return arr.reduce((accumulator, currentValue) => accumulator < currentValue ? currentValue : accumulator, 0);
};
...
const hasChildrenValues = (arr, character) => {
  let char = arr.find(obj => obj.name === character);
